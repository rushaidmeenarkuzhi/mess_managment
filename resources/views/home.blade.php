    ...
    <div class="justify-content-between">
        <div class="form-group">
             <div class="row">
                ...
                <div class="col-md-10">
                    <main class="main-content ms-md-4 ms-0">
                         <div class="row">
                              <div class="col-md-6">
                                    ...
                                    <div class="card text-white bg-warning">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="">
                                                    <h3 class="mb-1">{{ $stock->item_qty ?? 0 }}</h3>
                                   ...
                                   <div class="col-md-12 grid-margin stretch-card">
                                    <div class="card text-white bg-success">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="">
                                                    <h3 class="mb-1">{{ $stock->total_sale_qty ?? 0 }}</h3>
                                                    <h5 class="mb-0">Sale Quantity</h5>
                                                </div>
                                                <div class="col-4 text-end">
                                                    <i class="fa-solid fa-cart-shopping fa-3x opacity-75"></i>
                                                </div>
                                            </div>
                                        </div>
                                      </div>
...
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    ...
    <script>
        ...
        const lineCtx = document.getElementById('monthlySalesChart').getContext('2d');
        new Chart(lineCtx, {
            type: 'line',
            data: {
                labels: @json($months),
